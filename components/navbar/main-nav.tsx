        ...
        <div className="flex items-center gap-3">
          ...
          {!loading && user && (
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button className="flex items-center gap-2 rounded-full border border-pink-200/50 bg-gradient-to-br from-pink-100 to-violet-100 px-3 py-1.5 text-sm font-medium text-stone-700 transition-all hover:shadow-md hover:border-pink-300">
                  {user.avatarUrl ? (
                    ...
                    <div className="flex h-7 w-7 items-center justify-center rounded-full bg-gradient-to-br from-pink-400 to-violet-400 text-white text-xs font-bold">
              ...
              <DropdownMenuContent align="end" className="bg-white border-pink-100/60 shadow-lg shadow-pink-100/20 w-48">
