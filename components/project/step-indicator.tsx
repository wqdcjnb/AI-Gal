...
const steps: Step[] = [
  ...
  { number: 2, label: "章节工作台", shortLabel: "章节", icon: BookOpen, href: "/chapters" },
  { number: 3, label: "对话编辑", shortLabel: "对话", icon: MessageSquare, href: "/dialogue" },
  { number: 4, label: "在线预览", shortLabel: "预览", icon: Play, href: "/preview" },
  { number: 5, label: "导出", shortLabel: "导出", icon: Download, href: "/export" },
]
